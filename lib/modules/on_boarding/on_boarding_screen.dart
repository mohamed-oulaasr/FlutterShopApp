// ignore_for_file: prefer_const_constructors_in_immutables, prefer_const_literals_to_create_immutables, prefer_const_constructors, must_be_immutable, use_key_in_widget_constructors, avoid_print
...
class OnBoardingScreenState extends State<OnBoardingScreen>
{
  ...
  // Submit Save Data in Shared Preferences
  void submit()
  {
          ...
          [
            Expanded(
              child: PageView.builder(
                ...
                {
                  if(index == boarding.length - 1)   // last board
                  {
                    setState(()
                    {
                      isLast = true;
